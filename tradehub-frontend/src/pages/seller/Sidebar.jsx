    ...
    <div className="sidebar">
      <div className="sidebar-header">
        ...
        <nav className="sidebar-nav">
          <Link to="/seller-dashboard" className={`nav-item ${activePage === '/' ? 'active' : ''}`}>
          ...
          <Link to="/addproduct" className={`nav-item ${activePage.startsWith('/browser') ? 'active' : ''}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" fill="currentColor" viewBox="0 0 256 256">
              <path d="M229.66,218.34l-50.07-50.06a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z"></path>
            </svg>
            <span className="nav-text">Add Product</span>
          </Link>
          <Link to="/manageproduct" className={`nav-item ${activePage.startsWith('/orders') ? 'active' : ''}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" fill="currentColor" viewBox="0 0 256 256">
          ...
          <Link to="/manageorder" className={`nav-item ${activePage.startsWith('/cart') ? 'active' : ''}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" fill="currentColor" viewBox="0 0 256 256">
          ...
          <Link to="/selleranalysis" className={`nav-item ${activePage.startsWith('/account') ? 'active' : ''}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" fill="currentColor" viewBox="0 0 256 256">
              <path d="M230.92,212c-15.23-26.33-38.7-45.21-66.09-54.16a72,72,0,1,0-73.66,0C63.78,166.78,40.31,185.66,25.08,212a8,8,0,1,0,13.85,8c18.84-32.56,52.14-52,89.07-52s70.23,19.44,89.07,52a8,8,0,1,0,13.85-8ZM72,96a56,56,0,1,1,56,56A56.06,56.06,0,0,1,72,96Z"></path>
            </svg>
            <span className="nav-text">Seller Analysis</span>
          </Link>
        </nav>
      </div>
      <div className="sidebar-footer">
        <Link to="/logout2" className="nav-item">
          <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" fill="currentColor" viewBox="0 0 256 256">
